...
TEST(AnimalTest, WildAnimalFactoryHorse) {
  ...
  EXPECT_TRUE(AnimalConter::instance().count_of_animals("horse") == 1);
  ...
  delete animal;
  EXPECT_TRUE(AnimalConter::instance().count_of_animals("horse") == 0);
}
...
//   animal2->eat(1);
//   EXPECT_TRUE(AnimalConter::instance().count_of_animals("horse") == 0);
//   EXPECT_TRUE(AnimalConter::instance().count_of_animals("kenguru") == 2);  
...
//   delete animal;
//   EXPECT_TRUE(AnimalConter::instance().count_of_animals("kenguru") == 1);  
//   delete animal2;
//   EXPECT_TRUE(AnimalConter::instance().count_of_animals("kenguru") == 0);  
// }
...
//   EXPECT_TRUE(AnimalConter::instance().count_of_animals("dog") == 0);
// }
...
//   Animal* animal = factory.create("dog");
//   EXPECT_TRUE(AnimalConter::instance().count_of_animals("dog") == 1);
...
//   EXPECT_TRUE(AnimalConter::instance().count_of_animals("cat") == 1);
//   EXPECT_EQ(animal->type(), "home");
//   EXPECT_EQ(animal->say(), "I am a home cat, I am lazy and I feeded 0 kg");
//   delete animal;
//   EXPECT_TRUE(AnimalConter::instance().count_of_animals("cat") == 0);
// }
...
//   EXPECT_TRUE(AnimalConter::instance().count_of_animals("imaginary") == 1);
//   delete animal;
//   EXPECT_TRUE(AnimalConter::instance().count_of_animals("imaginary") == 0);
// }
